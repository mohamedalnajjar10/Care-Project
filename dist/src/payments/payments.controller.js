...
let PaymentsController = class PaymentsController {
    ...
    confirmPayment(paymentId, paymentIntentId) {
        return this.paymentsService.confirmPayment(paymentId, paymentIntentId);
    }
    async handlePaypalSuccess(token, paymentId) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Initiate payment for appointment' }),
...
__decorate([
    (0, common_1.Post)('confirm/:paymentId'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Handle PayPal success redirect' }),
    __param(0, (0, common_1.Query)('token')),
    __param(1, (0, common_1.Query)('paymentId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], PaymentsController.prototype, "handlePaypalSuccess", null);
__decorate([
    (0, common_1.Post)('refund/:appointmentId'),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get payment by appointment' }),
    __param(0, (0, common_1.Param)('appointmentId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "getPaymentByAppointment", null);
